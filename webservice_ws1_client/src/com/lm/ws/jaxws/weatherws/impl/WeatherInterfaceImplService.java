 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://impl.weatherws.jaxws.ws.lm.com/", wsdlLocation = "http://localhost:18659/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://impl.weatherws.jaxws.ws.lm.com/", "WeatherInterfaceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:18659/weather?wsdl");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://impl.weatherws.jaxws.ws.lm.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.weatherws.jaxws.ws.lm.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
