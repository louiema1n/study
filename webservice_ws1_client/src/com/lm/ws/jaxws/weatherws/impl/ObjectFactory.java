 ...
 * generated in the com.lm.ws.jaxws.weatherws.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.weatherws.jaxws.ws.lm.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://impl.weatherws.jaxws.ws.lm.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lm.ws.jaxws.weatherws.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.weatherws.jaxws.ws.lm.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.weatherws.jaxws.ws.lm.com/", name = "queryWeather")
