...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.lm.ws.mobile.server.GetDatabaseInfo")
    @WebMethod(action = "http://WebXml.com.cn/getDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.lm.ws.mobile.server.GetDatabaseInfoResponse")
    public com.lm.ws.mobile.server.ArrayOfString getDatabaseInfo();
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.lm.ws.mobile.server.GetMobileCodeInfo")
    @WebMethod(action = "http://WebXml.com.cn/getMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.lm.ws.mobile.server.GetMobileCodeInfoResponse")
