 ...
 * generated in the com.lm.ws.cxf.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.weather.cxf.ws.lm.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.weather.cxf.ws.lm.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lm.ws.cxf.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.weather.cxf.ws.lm.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.weather.cxf.ws.lm.com/", name = "queryWeatherResponse")
