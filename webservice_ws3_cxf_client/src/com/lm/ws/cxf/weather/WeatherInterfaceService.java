 ...
 * 2016-12-14T09:39:54.796+08:00
 * Generated source version: 3.1.8
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://127.0.0.1:18658/weather?wsdl",
                  targetNamespace = "http://server.weather.cxf.ws.lm.com/") 
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.weather.cxf.ws.lm.com/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://server.weather.cxf.ws.lm.com/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:18658/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherInterfaceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:18658/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
